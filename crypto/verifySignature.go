...
// verifySignature eeturns bool whether signature was verified
...
// loadPublicKeyFromPemFile loads a public RSA key from a PEM encoded file
...
func main() {
	...
	publicKeyFilename, signatureFilename, messageFilename := checkArgs()
