...
// getPrivatePemFromKey encodes the private key as a PEM file PEM is a base-64 encoding of the key
...
// generatePublicPemFromKey encodes the public key as a PEM file
