...
// If you don't want to create a self-signed certificate,
// you have to create a certificate signing request and have it
...
// saveCSRToPemFile creates a CSR PEM and save to file
