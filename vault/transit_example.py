...
# Create a key
r = requests.post(VAULT_ADDR + "/v1/transit/keys/my_test_key",
...
if 204 == r.status_code:  # The key was generated
    ...
    r = requests.post(VAULT_ADDR + "/v1/transit/encrypt/my_test_key",
    ...
    if 200 == r.status_code:  # Encryption OK
        ...
        # Decrypt
        r = requests.post(VAULT_ADDR + "/v1/transit/decrypt/my_test_key",
