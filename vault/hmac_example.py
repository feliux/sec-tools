...
r = requests.post(VAULT_ADDR + "/v1/sys/mounts/transit",
                  json={"type":"transit"},
...
# Create a key
r = requests.post(VAULT_ADDR + "/v1/transit/keys/my_test_hmac_key",
...
if 204 == r.status_code:  # The key was generated
    ...
    r = requests.post(VAULT_ADDR + "/v1/transit/hmac/my_test_hmac_key/sha2-256",
    ...
    if 200 == r.status_code:  # HMAC OK
        ...
        # Verify
        r = requests.post(VAULT_ADDR + "/v1/transit/verify/my_test_hmac_key/sha2-256",
